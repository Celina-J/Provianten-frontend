...
<template>
        ...
        <div class="container container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <div class="cart-link nav-link" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <form @submit.prevent="submitSearch()" class="d-flex">
                    <input v-model="searchValue" class="form-control me-2" type="search" placeholder="Sök produkt"
                        aria-label="Search">
    ...
    <div v-if="showCategories" id="categories-container" class="categories-container">
        <div class="item-container flx-c">
            <RouterLink class="link" :to="`category?id=${i.id}`" @click="toggleCategories()" v-for="i in categories"
                v-bind:key="i.id">
                {{ i.name }}
            </RouterLink>
        </div>
