...
<template>
        ...
        <div class="container container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a @click="toggleCategories()" class="nav-link" href="#">Kategorier</a>
                    </li>
    ...
    <div v-if="showCategories" id="categories-container" class="categories-container">
        <div class="item-container flx-c">
            <RouterLink class="link" to="#" @click="toggleCategories()" v-for="i in categories" v-bind:key="i.id">
                {{ i.name }}
            </RouterLink>
        </div>
    </div>

    <video v-if="url === '/'" class="hero-video" autoPlay loop>
